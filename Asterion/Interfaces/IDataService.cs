...
public interface IDataService
{
    ...
    /// <param name="customChannelId">
    ///     Custom channel, if it should differ from default channel, left null if default is to be
    ///     used
    /// </param>
    ...
    public Task<bool> UpdateModrinthProjectAsync(string projectId, string? newVersion = null, string? title = null,
