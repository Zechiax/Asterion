...
namespace Asterion.Migrations
{
    ...
    [Migration("20260704125200_AddPendingNotificationsAndWebhookUrl")]
    partial class AddPendingNotificationsAndWebhookUrl
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Asterion.Database.Models.PendingNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("SerializedProject")
                        .IsRequired()
                        .HasColumnType("TEXT");

                    b.Property<string>("SerializedVersion")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Asterion.Database.Models.PendingNotification", b =>
                {
                    b.HasOne("Asterion.Database.Models.ModrinthEntry", "Entry")
                        .WithMany()
